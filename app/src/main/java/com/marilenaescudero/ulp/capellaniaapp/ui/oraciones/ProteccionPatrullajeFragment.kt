...
import com.marilenaescudero.ulp.capellaniaapp.databinding.FragmentProteccionPatrullajeBinding
import com.marilenaescudero.ulp.capellaniaapp.modelo.oraciones.OracionDto

class ProteccionPatrullajeFragment : Fragment() {
    private var _binding: FragmentProteccionPatrullajeBinding? = null
    ...
    private val idCategoria = 3

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentProteccionPatrullajeBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun configurarRecycler() {
        ...
        binding.recyclerProteccionPatrullaje.layoutManager = LinearLayoutManager(requireContext())
        binding.recyclerProteccionPatrullaje.adapter = adapter
    }
    ...
    private fun navegarEditar(item: OracionDto) {
        ...
        findNavController().navigate(R.id.action_proteccionPatrullaje_to_editarContenidoOraciones, bundle)
    }
