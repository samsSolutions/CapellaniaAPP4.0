...
import com.marilenaescudero.ulp.capellaniaapp.databinding.FragmentFamiliaEsposoBinding
import com.marilenaescudero.ulp.capellaniaapp.modelo.familia.FamiliaItem


class FamiliaEsposoFragment : Fragment() {

    private var _binding: FragmentFamiliaEsposoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFamiliaEsposoBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Primera carga
        viewModel.cargarCategoria("esposo")
    ...
    private fun configurarRecycler() {
        ...
        binding.recyclerEsposo.layoutManager = LinearLayoutManager(requireContext())
        binding.recyclerEsposo.adapter = adapter
    }
    ...
    private fun aplicarPermisos() {
        ...
        binding.btnAgregar.setOnClickListener {
            AgregarContenidoFamilia("esposo") { nuevoItem ->
    ...
    private fun navegarEditar(item: FamiliaItem) {
        ...
        findNavController().navigate(R.id.action_esposo_to_editarContenido, bundle)
    }
