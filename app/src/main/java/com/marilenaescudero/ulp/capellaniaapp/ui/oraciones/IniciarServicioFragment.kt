...
class IniciarServicioFragment : Fragment() {

    private var _binding: FragmentIniciarServicioBinding? = null
    ...
    private val idCategoria = 1

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentIniciarServicioBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun configurarRecycler() {
        ...
        binding.recyclerIniciarServicio.layoutManager = LinearLayoutManager(requireContext())
        binding.recyclerIniciarServicio.adapter = adapter
    }
    ...
    private fun navegarEditar(item: OracionDto) {
        ...
        findNavController().navigate(R.id.action_iniciarServicio_to_editarContenidoOraciones, bundle)
    }
